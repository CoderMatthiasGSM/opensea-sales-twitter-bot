...
function formatAndSendTweet(event) {
    ...
    const tweetText = `${tokenName} bought for ${formattedTokenPrice}${formattedPriceSymbol} ($${formattedUsdPrice}). Aradena welcomes you! https://warriorsofaradena.com/ ${openseaLink}`;
